...
function generate_practice_block(
  ...
  for (var ii = 0; ii < num_trial; ii++) {
    ...
    var bubble_phase = {
      ...
      prompt:
        "<p class = block-text>How untruthful/truthful is the information in this post?  Click 3-" +
        maximum_click +
...
function generate_main_block(
  ...
  var main_instructions_page = {
    type: "instructions",
    pages: [
      "<div class = centerbox ><p class = center-block-text >You finished the practice and are about to begin the main task.</p>" +
        "<p class = center-block-text>Please take the study seriously.</p>" +
        "<p class = center-block-text>Again, we very much appreciate your participation!</p></div>",
      "<div class = centerbox><p class = center-block-text >Now the actual trial will start. In a previous study, approximately 75% of politically conservative  participants who viewed this post found that it contains  false information.</p>",
    ],
    allow_keys: false,
    show_clickable_nav: true,
    allow_backward: false,
