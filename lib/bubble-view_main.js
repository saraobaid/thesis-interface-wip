...
function generate_main_block(
  ...
  var main_instructions_page = {
    ...
    pages: [
      ...
      "<div class = centerbox><p class = callout>In a previous study, approximately 75% of politically conservative participants who viewed the following post found that it contains false information.</p></div>",
    ],
    allow_keys: false,
    show_clickable_nav: true,
    allow_backward: false,
