...
function generate_practice_block(
  ...
  for (var ii = 0; ii < num_trial; ii++) {
    ...
    var bubble_phase = {
      ...
      prompt:
        "<div class = block-text><p class = center-block-text>To the best of your knowledge, how accurate is the claim in this post?</p> <p class = understate>  Click 3-" +
        maximum_click +
...
function generate_main_block(
  ...
  for (var ii = 0; ii < num_trial; ii++) {
    ...
    var bubble_phase = {
      ...
      prompt:
        "<div class = block-text><p class = center-block-text>To the best of your knowledge, how accurate are the claim(s) in this post?</p> <p class = understate>  Click 3-" +
        maximum_click +
        "</font></b> times, then press Next to make your rating.</p>",
      trial_type: "fixed_click_maximum", // or 'fixed_viewing_duration'
      maximum_click: maximum_click,
